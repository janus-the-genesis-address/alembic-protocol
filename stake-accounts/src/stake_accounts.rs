...
mod tests {
    ...
    fn create_bank(lamports: u64) -> (Arc<Bank>, Keypair, u64, u64) {
        ...
        genesis_config.fee_rate_governor = Alembic_sdk::fee_calculator::FeeRateGovernor::new(0, 0);
    ...
    fn test_new_derived_stake_account() {
        ...
        let stake_authority_pubkey = Alembic_sdk::pubkey::new_rand();
        let withdraw_authority_pubkey = Alembic_sdk::pubkey::new_rand();
    ...
    fn test_authorize_stake_accounts() {
        ...
        let new_stake_authority_pubkey = Alembic_sdk::pubkey::new_rand();
        let new_withdraw_authority_pubkey = Alembic_sdk::pubkey::new_rand();
