...
fn fee_payer_arg<'a, 'b>() -> Arg<'a, 'b> {
    Alembic_clap_utils::fee_payer::fee_payer_arg().required(true)
}
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. http://api.devnet.genesisaddress.ai"),
        )
        .subcommand(
            SubCommand::with_name("new")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("Amount to move into the new stake accounts, in TACHYON"),
                )
                .arg(
                    Arg::with_name("stake_authority")
                        .long("stake-authority")
