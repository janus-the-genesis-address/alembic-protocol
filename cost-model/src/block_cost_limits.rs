...
/// is currently publicly communicated on genesisaddress.ai
pub const MAX_BLOCK_REPLAY_TIME_US: u64 = 400_000;
/// number of concurrent processes,
pub const MAX_CONCURRENCY: u64 = 4;

// Cluster data, method of collecting at https://github.com/Alembic-labs/Alembic/issues/19627
// Dashboard: https://metrics.genesisaddress.ai/d/monitor-edge/cluster-telemetry?orgId=1
...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        (Alembic_stake_program::id(), Alembic_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
        (Alembic_config_program::id(), Alembic_config_program::config_processor::DEFAULT_COMPUTE_UNITS),
        (Alembic_vote_program::id(), Alembic_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS),
        (Alembic_system_program::id(), Alembic_system_program::system_processor::DEFAULT_COMPUTE_UNITS),
        (compute_budget::id(), Alembic_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        (address_lookup_table::program::id(), Alembic_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS),
        (bpf_loader_upgradeable::id(), Alembic_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS),
        (bpf_loader_deprecated::id(), Alembic_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS),
        (bpf_loader::id(), Alembic_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS),
        (loader_v4::id(), Alembic_loader_v4_program::DEFAULT_COMPUTE_UNITS),
