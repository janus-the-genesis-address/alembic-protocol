...
cat <<'EOF'
  ...
  see https://docs.genesisaddress.ailabs.com/cli/examples/test-validator

  If you are a prospective validator, please see https://docs.genesisaddress.ailabs.com/operations
