...
pub mod Alembic_rpc_client {
    pub mod rpc_client {
        use {
            super::super::{
                Alembic_rpc_client_api::client_error::Result as ClientResult,
                Alembic_sdk::{
...
pub mod Alembic_rpc_client_api {
...
pub mod Alembic_rpc_client_nonce_utils {
    use {
        super::Alembic_sdk::{account::ReadableAccount, account_utils::StateMut, pubkey::Pubkey},
...
/// Re-exports and mocks of Alembic-program modules that mirror those from
/// Alembic-program.
///
/// This lets examples in Alembic-program appear to be written as client
/// programs.
pub mod Alembic_sdk {
    pub use crate::{
    ...
    #[deprecated(
        since = "1.17.0",
        note = "Please use `Alembic_sdk::address_lookup_table` instead"
    )]
...
pub mod Alembic_address_lookup_table_program {
