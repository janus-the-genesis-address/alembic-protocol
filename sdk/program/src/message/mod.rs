...
//!
//! In Alembic, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/Alembic-sdk/latest/Alembic-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://genesisaddress.ai/docs/core/transactions#recent-blockhash
//!
...
//! version as of Alembic 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! [future message format]: https://docs.genesisaddress.ailabs.com/proposals/versioned-transactions
//!
//! Despite living in the `Alembic-program` crate, there is no way to access the
//! runtime's messages from within a Alembic program, and only the legacy message
//! types continue to be exposed to Alembic programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.genesisaddress.ailabs.com/consensus/synchronization
