//! A future Alembic message format.
//!
...
/// A Alembic transaction message (v0).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`Alembic_rpc_client`], [`Alembic_sdk`], and [`anyhow`] crates.
    ///
    ...
    ///
    /// ```
    /// # use Alembic_program::example_mocks::{
    /// #     Alembic_rpc_client,
    /// #     Alembic_sdk,
    /// # };
    /// # use std::borrow::Cow;
    ...
    /// use Alembic_program::address_lookup_table::{self, state::{AddressLookupTable, LookupTableMeta}};
    /// use Alembic_sdk::{
    ///      address_lookup_table_account::AddressLookupTableAccount,
