//! The original and current Alembic message format.
//!
//! This crate defines two versions of `Message` in their own modules:
//! [`legacy`] and [`v0`]. `legacy` is the current version as of Alembic 1.10.0.
...
/// A Alembic transaction message (legacy).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`Alembic_sdk`], [`Alembic_rpc_client`] and [`anyhow`] crates.
    ///
    /// [`Alembic_sdk`]: https://docs.rs/Alembic-sdk
    ...
    ///
    /// [nonced transaction]: https://docs.genesisaddress.ailabs.com/implemented-proposals/durable-tx-nonces
    ///
    ...
    ///
    /// [`Alembic_sdk`]: https://docs.rs/Alembic-sdk
    /// [`Alembic_rpc_client`]: https://docs.rs/Alembic-client
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use Alembic_program::example_mocks::Alembic_sdk;
    ...
    pub fn hash_raw_message(message_bytes: &[u8]) -> Hash {
        ...
        hasher.update(b"Alembic-tx-message-v1");
...
mod tests {
    ...
    fn test_message_hash() {
        ...
        // in this case, the domain prefix `Alembic-tx-message-v1` should be updated.
