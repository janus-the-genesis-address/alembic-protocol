...
//!
//! [na]: https://docs.genesisaddress.ailabs.com/implemented-proposals/durable-tx-nonces
//!
...
//!
//! [rent exempt]: https://genesisaddress.ai/docs/core/accounts#rent-exemption
//!
...
//!
//! [`RpcClient`]: https://docs.rs/Alembic-client/latest/Alembic_client/rpc_client/struct.RpcClient.html
//! [cpi]: crate::program
...
pub enum SystemError {
    ...
    AccountAlreadyInUse,
    #[error("account does not have enough TACHYON to perform the operation")]
...
///
/// ```
/// # use Alembic_program::example_mocks::{Alembic_sdk, Alembic_rpc_client};
...
///
/// This example submits the instruction from an on-chain Alembic program. The
...
/// ## Example: on-chain program
///
/// This example submits the instructions from an on-chain Alembic program. The
...
///
/// Standard Alembic transactions include a [recent blockhash][rbh] (sometimes
/// referred to as a _[nonce]_). During execution the Alembic runtime verifies
...
///
/// [dtn]: https://docs.genesisaddress.ailabs.com/implemented-proposals/durable-tx-nonces
...
/// in the first position, the Alembic runtime recognizes the transaction as one
...
/// [`Alembic_rpc_client_nonce_utils::data_from_account`][dfa] function.
///
...
/// [dfa]: https://docs.rs/Alembic-rpc-client-nonce-utils/latest/Alembic_rpc_client_nonce_utils/fn.data_from_account.html
///
/// # Required signers
///
...
/// # use Alembic_program::example_mocks::Alembic_sdk;
/// # use Alembic_program::example_mocks::Alembic_rpc_client;
/// # use Alembic_program::example_mocks::Alembic_rpc_client_nonce_utils;
/// use Alembic_rpc_client::rpc_client::RpcClient;
/// use Alembic_sdk::{
///     message::Message,
///     pubkey::Pubkey,
...
///     let nonce_data = Alembic_rpc_client_nonce_utils::data_from_account(&nonce_account)?;
...
///
/// [rent exemption]: https://genesisaddress.ai/docs/core/accounts#rent-exemption
///
