//! Types for directing the execution of Alembic programs.
//!
//! Every invocation of a Alembic program executes a single instruction, as
...
//! the Alembic runtime. This allows flexibility in how programs behave, how they
...
#[cfg_attr(not(target_os = "Alembic"), derive(AbiExample, AbiEnumVisitor))]
...
pub enum InstructionError {
    ...
    /// by the Alembic runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Alembic software versions.
    ///
...
/// A directive for a single invocation of a Alembic program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Alembic
...
/// construction.
///
/// While Alembic is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Alembic runtime coalesces all accounts used
...
///
/// Note that because the Alembic runtime schedules parallel transaction
...
/// which is the core of a Alembic transaction. It is created during the
