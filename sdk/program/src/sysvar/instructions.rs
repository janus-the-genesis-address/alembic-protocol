...
//!
//! [in]: https://docs.genesisaddress.ailabs.com/implemented-proposals/instruction_introspection
...
//!
//! See also the Alembic [documentation on the instructions sysvar][sdoc].
//!
//! [sdoc]: https://docs.genesisaddress.ailabs.com/runtime/sysvars#instructions
//!
//! # Examples
//!
//! For a complete example of how the instructions sysvar is used see the
//! documentation for [`secp256k1_instruction`] in the `Alembic-sdk` crate.
//!
//! [`secp256k1_instruction`]: https://docs.rs/Alembic-sdk/latest/Alembic_sdk/secp256k1_instruction/index.html
...
///
/// This function is used by the runtime and not available to Alembic programs.
#[cfg(not(target_os = "Alembic"))]
