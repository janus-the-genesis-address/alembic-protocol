...
//!
//! See also the Alembic [documentation on the epoch rewards sysvar][sdoc].
//!
//! [sdoc]: https://docs.genesisaddress.ailabs.com/runtime/sysvars#epochrewards
//!
//! # Examples
//!
...
//! # use Alembic_sdk::sysvar::epoch_rewards::{self, EpochRewards};
//! # use anyhow::Result;
//! #
