...
//!
//! See also the Alembic [SIMD proposal][simd].
//!
//! [simd]: https://github.com/Alembic-foundation/Alembic-improvement-documents/blob/main/proposals/0047-syscall-and-sysvar-for-last-restart-slot.md
//!
//! # Examples
//!
