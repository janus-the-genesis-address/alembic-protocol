...
//!
//! See also the Alembic [documentation on the epoch schedule sysvar][sdoc].
//!
//! [sdoc]: https://docs.genesisaddress.ailabs.com/runtime/sysvars#epochschedule
//!
//! # Examples
//!
...
//! # use Alembic_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
