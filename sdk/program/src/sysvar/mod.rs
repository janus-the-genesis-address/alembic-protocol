...
//! ```
//!
//! Since Alembic sysvars are accounts, if the `AccountInfo` is provided to the
...
//!
//! For more details see the Alembic [documentation on sysvars][sysvardoc].
//!
//! [sysvardoc]: https://docs.genesisaddress.ailabs.com/runtime/sysvars
