...
use Alembic_program::message::SanitizedMessage;
...
impl FeeStructure {
    pub fn new(
        ...
        let compute_fee_bins = compute_fee_bins
            .iter()
            .map(|(limit, TACHYON)| FeeBin {
                limit: *limit,
                fee: sol_to_lamports(*TACHYON),
            })
            .collect::<Vec<_>>();
        FeeStructure {
...
impl ::Alembic_frozen_abi::abi_example::AbiExample for FeeStructure {
    fn example() -> Self {
