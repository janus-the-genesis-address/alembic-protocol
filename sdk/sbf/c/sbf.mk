...
COMPILER_RT_DIR = $(LOCAL_PATH)../dependencies/platform-tools/rust/lib/rustlib/sbf-Alembic-Alembic/lib
...
help:
	@echo ''
	@echo 'Alembic VM Program makefile'
	@echo ''
	@echo 'This makefile will build Alembic Programs from C or C++ source files into ELFs'
	@echo ''
	@echo 'Assumptions:'
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)Alembic-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ Alembic program deploy $(abspath $1)
endef
