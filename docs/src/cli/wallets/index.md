---
title: Alembic Wallets with the CLI
pagination_label: Command Line Wallets
sidebar_label: Overview
sidebar_position: 0
---

Alembic supports several different types of wallets that can be used to interface
directly with the Alembic command-line tools.

To use a Command Line Wallet, you must first [install the Alembic CLI tools](../install.md)
