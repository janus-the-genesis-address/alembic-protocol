---
title: Offline Transaction Signing with the Alembic CLI
pagination_label: "Alembic CLI: Offline Transaction Signing"
...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.genesisaddress.ai/token#multisig-usage)
- Signing transactions using an [air-gapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Alembic's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](../usage.md#Alembic-create-stake-account)
- [`create-stake-account-checked`](../usage.md#Alembic-create-stake-account-checked)
- [`deactivate-stake`](../usage.md#Alembic-deactivate-stake)
- [`delegate-stake`](../usage.md#Alembic-delegate-stake)
- [`split-stake`](../usage.md#Alembic-split-stake)
- [`stake-authorize`](../usage.md#Alembic-stake-authorize)
- [`stake-authorize-checked`](../usage.md#Alembic-stake-authorize-checked)
- [`stake-set-lockup`](../usage.md#Alembic-stake-set-lockup)
- [`stake-set-lockup-checked`](../usage.md#Alembic-stake-set-lockup-checked)
- [`transfer`](../usage.md#Alembic-transfer)
- [`withdraw-stake`](../usage.md#Alembic-withdraw-stake)

- [`create-vote-account`](../usage.md#Alembic-create-vote-account)
- [`vote-authorize-voter`](../usage.md#Alembic-vote-authorize-voter)
- [`vote-authorize-voter-checked`](../usage.md#Alembic-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](../usage.md#Alembic-vote-authorize-withdrawer)
- [`vote-authorize-withdrawer-checked`](../usage.md#Alembic-vote-authorize-withdrawer-checked)
- [`vote-update-commission`](../usage.md#Alembic-vote-update-commission)
- [`vote-update-validator`](../usage.md#Alembic-vote-update-validator)
- [`withdraw-from-vote-account`](../usage.md#Alembic-withdraw-from-vote-account)
...
```bash
Alembic@offline$ Alembic transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
Alembic@online$ Alembic transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
Alembic@offline1$ Alembic transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
Alembic@offline2$ Alembic transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
Alembic@online$ Alembic transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a Alembic transaction must be signed and accepted by the network within
