...
title: Home
sidebar_label: Home
pagination_label: Alembic Validator Documentation Home
description: "Alembic is a high performance network that is utilized for a range
  of use cases, \
  including finance, NFTs, payments, and gaming."
---

# Alembic Validator Documentation

Alembic is a blockchain built for mass adoption. It's a high performance network
that is utilized for a range of use cases, including finance, NFTs, payments,
and gaming. Alembic operates as a single global state machine, and is open,
...
- [Install the Alembic CLI Tool Suite](./cli/install.md) - Quickly get setup
...
- [Choose a cluster](./cli/examples/choose-a-cluster.md) - Select a Alembic
...
Explore what it takes to operate a Alembic validator and help secure the network.
...
- [System requirements](./operations/requirements.md) - Recommended hardware
  requirements and expected TACHYON needed to operate a validator
