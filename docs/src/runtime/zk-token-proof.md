---
title: Alembic ZK Token Proof Program
pagination_label: Native ZK Token Proof Program
sidebar_label: ZK Token Proof Program
---

The native Alembic ZK Token proof program verifies a number of zero-knowledge
...
for the [SPL Token 2022](https://spl.genesisaddress.ai/token-2022) program. However,
...
- Instructions:
  [ProofInstruction](https://github.com/Alembic-labs/Alembic/blob/master/zk-token-sdk/src/zk_token_proof_instruction.rs)
...
- [Notes](https://github.com/Alembic-labs/Alembic/blob/master/docs/src/runtime/zk-docs/twisted_elgamal.pdf)
  on the twisted ElGamal encryption
- A technical
  [overview](https://github.com/Alembic-labs/Alembic-program-library/blob/master/token/zk-token-protocol-paper/part1.pdf)
...
part of a larger Alembic transaction that contains instructions of other Alembic
...
- `VerifyPubkeyValidity`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/Alembic-labs/Alembic/blob/master/docs/src/runtime/zk-docs/pubkey_proof.pdf)
...
- `VerifyZeroBalance`:
  ...
  - The zero-balance proof certifies that an ElGamal ciphertext encrypts the
    number zero.
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/Alembic-labs/Alembic/blob/master/docs/src/runtime/zk-docs/zero_proof.pdf)
...
- `VerifyCiphertextCommitmentEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/Alembic-labs/Alembic/blob/master/docs/src/runtime/zk-docs/ciphertext_commitment_equality.pdf)
...
- `VerifyCiphertextCiphertextEquality`:
  ...
  - Mathematical description and proof of security:
    [[Notes]](https://github.com/Alembic-labs/Alembic/blob/master/docs/src/runtime/zk-docs/ciphertext_ciphertext_equality.pdf)
