...
- `node_pubkey` - The Alembic node that votes in this account.
...
[inflation](https://genesisaddress.ai/docs/terminology#inflation). The number of
...
[point](https://genesisaddress.ai/docs/terminology#point).
...
[sysvar](https://genesisaddress.ai/docs/terminology#sysvar) that maps epochs to point
values.
