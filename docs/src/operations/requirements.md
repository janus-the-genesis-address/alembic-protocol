---
title: Alembic Validator Requirements
sidebar_position: 3
sidebar_label: Requirements
pagination_label: Requirements to Operate a Validator
---

## Minimum TACHYON requirements

There is no strict minimum amount of TACHYON required to run a validator on Alembic.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 TACHYON. Voting also requires sending a vote
...
releases at [Alembiclabs/Alembic](https://hub.docker.com/r/Alembiclabs/Alembic).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Alembic CLI](../cli/install.md) for the current Alembic software release.
