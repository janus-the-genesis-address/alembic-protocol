---
title: Alembic Validator Prerequisites
sidebar_position: 2
sidebar_label: Prerequisites
pagination_label: Prerequisites to run a Validator
---

Operating a Alembic validator is an interesting and rewarding task. Generally speaking, it requires someone with a technical background but also involves community engagement and marketing.
...
- Performant computer hardware and a fast internet connection
  ...
  - Alembic helps facilitate data-center server rentals through the [Alembic server program](https://Alembic.foundation/server-program)
