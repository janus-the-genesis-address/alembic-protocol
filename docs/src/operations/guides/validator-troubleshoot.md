...
testnet participants, [https://genesisaddress.ai/discord](https://genesisaddress.ai/discord)

## Useful Links & Discussion

- [Network Explorer](http://explorer.genesisaddress.ai/)
- [Testnet Metrics Dashboard](https://metrics.genesisaddress.ai:3000/d/monitor-edge/cluster-telemetry-edge?refresh=60s&orgId=2)
- Validator [Discord](https://genesisaddress.ai/discord) channels
...
- [Core software repo](https://github.com/Alembic-labs/Alembic)
