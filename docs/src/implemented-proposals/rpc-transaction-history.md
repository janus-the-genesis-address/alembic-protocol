...
- [getFirstAvailableBlock](https://genesisaddress.ai/docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://genesisaddress.ai/docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://genesisaddress.ai/docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://genesisaddress.ai/docs/rpc/http/getconfirmedsignaturesforaddress)
...
the use of a new `Alembic-ledger-tool` command that will convert rocksdb data for
