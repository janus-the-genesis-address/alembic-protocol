...
*Paraphrasing from https://github.com/Alembic-labs/Alembic/issues/26847*
...
3. The `start offset` should be *after* the `rewarding interval`
   (from [Partitioned Inflationary Rewards Distribution](https://github.com/Alembic-labs/Alembic/pull/27455)).
