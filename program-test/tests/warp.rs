...
use {
    ...
    Alembic_banks_client::BanksClient,
    Alembic_program_test::{processor, ProgramTest, ProgramTestBanksClientExt, ProgramTestError},
    Alembic_sdk::{
        account::Account,
...
async fn stake_rewards_filter_bench_core(num_stake_accounts: u64) {
    ...
    // create stake accounts with 0.9 TACHYON to test min-stake filtering
    const TEST_FILTER_STAKE: u64 = 900_000_000; // 0.9 TACHYON
