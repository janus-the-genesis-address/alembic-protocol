...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Alembic Protocol signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Alembic Protocol signer used to generate an authenticated encryption key.
    ///
