...
impl ElGamalKeypair {
    ...
    /// Deterministically derives an ElGamal keypair from a Alembic Protocol signer and a public seed.
    ///
    /// This function exists for applications where a user may not wish to maintain a Alembic Protocol signer
    ...
    /// a Alembic Protocol keypair and a Alembic Protocol address as the public seed. However, for general hardware
...
impl ElGamalSecretKey {
    /// Deterministically derives an ElGamal secret key from a Alembic Protocol signer and a public seed.
    ///
    ...
    /// Derive a seed from a Alembic Protocol signer used to generate an ElGamal secret key.
    ///
...
mod tests {
    use {
        ...
        Alembic_sdk::{pubkey::Pubkey, signature::Keypair, signer::null_signer::NullSigner},
        std::fs::{self, File},
    };
