...
identity=$Alembic_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$Alembic_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$Alembic_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
