...
usage() {
  ...
  echo " Run bench-tps "
  echo
  echo "   extra args: additional arguments are passed along to Alembic-bench-tps"
  echo
  exit 1
}
...
default_arg --client-node-id "${Alembic_CONFIG_DIR}/bootstrap-validator/identity.json"

$Alembic_bench_tps "${args[@]}"
