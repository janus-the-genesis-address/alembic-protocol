...
stake_sol=10   # default number of TACHYON to assign as stake (10 TACHYON)
...
usage: $0 [OPTIONS] <TACHYON to stake ($stake_sol)>
...
VALIDATOR_KEYS_DIR=$Alembic_CONFIG_DIR/validator$label
...
if ((airdrops_enabled)); then
  ...
  $Alembic_cli \
    "${common_args[@]}" --keypair "$Alembic_CONFIG_DIR/faucet.json" \
