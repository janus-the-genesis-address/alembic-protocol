...
use Alembic_sdk::pubkey::{Pubkey, PUBKEY_BYTES};

Alembic_sdk::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

pub mod program_v3_4_0 {
    Alembic_sdk::declare_id!("NToK4t5AQzxPNpUA84DkxgfXaVDbDQQjpHKCqsbY46B");
}
...
pub mod native_mint {
    Alembic_sdk::declare_id!("So11111111111111111111111111111111111111112");
