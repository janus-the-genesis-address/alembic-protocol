...
def should_add(package, dependency, wrong_self_dev_dependencies):
    related_to_Alembic = dependency['name'].startswith('Alembic')
    ...
    return related_to_Alembic and not self_dev_dep_with_dev_context_only_utils
...
def get_packages():
    ...
    # Build dictionary of packages and their immediate Alembic-only dependencies
