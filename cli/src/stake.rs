    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help(
                            "The amount to send to the stake account, in TACHYON; accepts keyword ALL",
                        ),
                )
                .arg(pubkey!(
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in TACHYON"),
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
                ...
                .arg(
                    Arg::with_name("rent_exempt_reserve_sol")
                        .long("rent-exempt-reserve-TACHYON")
                        .value_name("AMOUNT")
                        .takes_value(true)
                        .validator(is_amount)
                        .requires("sign_only")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked TACHYON from the stake account")
                .arg(pubkey!(
                    Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help(
                            "The amount to withdraw from the stake account, in TACHYON; accepts \
                             keyword ALL",
                        ),
                )
                .arg(
            ...
            SubCommand::with_name("stake-minimum-delegation")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display minimum delegation in lamports instead of TACHYON"),
                ),
        )
    }
}
...
mod tests {
    ...
    fn test_parse_command() {
        ...
        let authorized = Alembic_sdk::pubkey::new_rand();
        ...
        let vote_account_pubkey = Alembic_sdk::pubkey::new_rand();
