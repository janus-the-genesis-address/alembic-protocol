...
use {
    ...
    Alembic_cli_output::{parse_sign_only_reply_string, OutputFormat},
    ...
    Alembic_rpc_client_nonce_utils::blockhash_query::{self, BlockhashQuery},
    Alembic_sdk::{
    ...
    Alembic_test_validator::{TestValidator, TestValidatorGenesis},
};
...
fn test_nonced_stake_delegation_and_deactivation() {
    ...
    // Fetch nonce hash
    let nonce_hash = Alembic_rpc_client_nonce_utils::get_account_with_commitment(
        &rpc_client,
        &nonce_account.pubkey(),
        CommitmentConfig::processed(),
    )
    .and_then(|ref a| Alembic_rpc_client_nonce_utils::data_from_account(a))
    .unwrap()
    .blockhash();
...
fn test_stake_authorize() {
    ...
    let new_nonce_hash = Alembic_rpc_client_nonce_utils::get_account_with_commitment(
        &rpc_client,
        &nonce_account.pubkey(),
        CommitmentConfig::processed(),
    )
