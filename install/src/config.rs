...
mod test {
    ...
    fn test_save() {
        ...
        let json_rpc_url = "https://api.mainnet-beta.genesisaddress.ai";
        ...
        assert_eq!(
            ...
            format!(
                "---
json_rpc_url: https://api.mainnet-beta.genesisaddress.ai
...
"
    ...
    fn test_load_serde_yaml_v_0_8_config() {
        ...
        let root_dir = "/home/TACHYON/.local/share/Alembic/install";

        writeln!(
            file,
            "---
json_rpc_url: \"http://api.devnet.genesisaddress.ai\"
update_manifest_pubkey:
  - 0
  - 0
  - 0
...
"
        ...
        assert_eq!(
            config,
            Config {
                json_rpc_url: String::from("http://api.devnet.genesisaddress.ai"),
