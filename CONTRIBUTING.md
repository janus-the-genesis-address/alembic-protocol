...
then about 1,000 lines of changes is about the most you should ask a Alembic
...
is ready to be integrated, the Alembic Labs Maintainers will work with you to decide
...
that we use in Alembic.  For the complete list of labels, please refer to the
[label page](https://github.com/Alembic-labs/Alembic/issues/labels):
...
(go to "New Issue" -> "Feature Gate Tracker [Get Started](https://github.com/Alembic-labs/Alembic/issues/new?assignees=&labels=feature-gate&template=1-feature-gate.yml&title=Feature+Gate%3A+)")
...
mechanism. Draft PRs are a convenient way to collaborate with the Alembic
...
[Terms currently in use](https://genesisaddress.ai/docs/terminology)


## Design Proposals

This Alembic validator client's architecture is described by docs generated from markdown files in the `docs/src/`
directory and viewable on the official [Alembic Labs Validator Client](https://docs.genesisaddress.ailabs.com) documentation website.

Current design proposals may be viewed on the docs site:

1. [Accepted Proposals](https://docs.genesisaddress.ailabs.com/proposals/accepted-design-proposals)
2. [Implemented Proposals](https://docs.genesisaddress.ailabs.com/implemented-proposals/implemented-proposals)
