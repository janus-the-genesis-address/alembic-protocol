...
use {
    ...
    Alembic_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/Alembic-labs/Alembic-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(Alembic_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]
