...
use {
    ...
    Alembic_metrics::inc_new_counter_error,
    Alembic_perf::packet::{Packet, PacketBatch},
...
impl WindowService {
    ...
    fn start_check_duplicate_thread(
        ...
        let handle_error = || {
            inc_new_counter_error!("Alembic-check-duplicate-error", 1, 1);
        };
        Builder::new()
    ...
    fn start_window_insert_thread(
        ...
        let handle_error = || {
            inc_new_counter_error!("Alembic-window-insert-error", 1, 1);
        };
