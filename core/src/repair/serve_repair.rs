...
mod tests {
    use {
        ...
        Alembic_gossip::{contact_info::ContactInfo, socketaddr, socketaddr_any},
        Alembic_ledger::{
        ...
        Alembic_perf::packet::{deserialize_from_with_limit, Packet},
    ...
    fn test_serialize_deserialize_signed_request() {
        ...
        let repair_peer_id = Alembic_sdk::pubkey::new_rand();
    ...
    fn test_repair_with_repair_validators() {
        ...
        for pubkey in &[Alembic_sdk::pubkey::new_rand(), *me.pubkey()] {
