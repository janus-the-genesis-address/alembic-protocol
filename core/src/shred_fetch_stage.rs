...
use {
    ...
    Alembic_ledger::shred::{should_discard_shred, ShredFetchStats},
    Alembic_perf::packet::{PacketBatch, PacketBatchRecycler, PacketFlags, PACKETS_PER_BATCH},
    ...
    Alembic_streamer::streamer::{self, PacketBatchReceiver, StreamerReceiveStats},
    std::{
...
mod tests {
    ...
    fn test_data_code_same_index() {
        ...
        let coding = Alembic_ledger::shred::Shredder::generate_coding_shreds(
            &[shred],
            3, // next_code_index
