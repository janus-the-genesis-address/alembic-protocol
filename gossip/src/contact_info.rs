...
pub use {
    crate::legacy_contact_info::LegacyContactInfo, Alembic_client::connection_cache::Protocol,
};
...
impl ContactInfo {
    pub fn new(pubkey: Pubkey, wallclock: u64, shred_version: u16) -> Self {
        Self {
            ...
            shred_version,
            version: Alembic_version::Version::default(),
...
impl Alembic_frozen_abi::abi_example::AbiExample for ContactInfo {
    fn example() -> Self {
        Self {
            ...
            version: Alembic_version::Version::example(),
