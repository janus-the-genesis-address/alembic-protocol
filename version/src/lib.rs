...
use {
    ...
    Alembic_sdk::{sanitize::Sanitize, serde_varint},
...
impl Default for Version {
    fn default() -> Self {
        let feature_set = u32::from_le_bytes(
            Alembic_sdk::feature_set::ID.as_ref()[..4]
                .try_into()
                .unwrap(),
        );
        Self {
            ...
            client: u16::try_from(ClientId::AlembicLabs).unwrap(),
        }
    }
}
...
mod test {
    ...
    #[test]
    fn test_client_id() {
        assert_eq!(ClientId::from(0u16), ClientId::AlembicLabs);
        ...
        assert_eq!(u16::try_from(ClientId::AlembicLabs), Ok(0u16));
