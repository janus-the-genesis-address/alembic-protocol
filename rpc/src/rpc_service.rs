//! The `rpc_service` module implements the Alembic JSON RPC service.
...
use {
    ...
    Alembic_perf::thread::renice_this_thread,
    Alembic_poh::poh_recorder::PohRecorder,
    Alembic_runtime::{
    ...
    Alembic_send_transaction_service::send_transaction_service::{self, SendTransactionService},
    ...
    match path {
        "/v0/circulating-supply" => {
            ...
            let non_circulating_supply =
                Alembic_runtime::non_circulating_supply::calculate_non_circulating_supply(&bank)
...
impl JsonRpcService {
    ...
    pub fn new(
        ...
        let (bigtable_ledger_storage, _bigtable_ledger_upload_service) =
            ...
            {
                let bigtable_config = Alembic_storage_bigtable::LedgerStorageConfig {
                ...
                runtime
                    .block_on(Alembic_storage_bigtable::LedgerStorage::new_with_config(
                        bigtable_config,
                    ))
...
mod tests {
    use {
        ...
        Alembic_rpc_client_api::config::RpcContextConfig,
    ...
    fn test_rpc_new() {
        ...
        let rpc_addr = SocketAddr::new(
            ip_addr,
            Alembic_net_utils::find_available_port_in_range(ip_addr, (10000, 65535)).unwrap(),
        );
