...
impl Alembic_frozen_abi::abi_example::AbiExample for LoadedProgram {
    fn example() -> Self {
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl<FG: ForkGraph> Alembic_frozen_abi::abi_example::AbiExample for ProgramCache<FG> {
    fn example() -> Self {
...
mod tests {
    use {
        ...
        Alembic_rbpf::program::BuiltinProgram,
        Alembic_sdk::{clock::Slot, pubkey::Pubkey},
        std::{
            ops::ControlFlow,
            sync::{
                atomic::{AtomicU64, Ordering},
