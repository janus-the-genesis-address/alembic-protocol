...
impl ::Alembic_frozen_abi::abi_example::AbiExample for SysvarCache {
    fn example() -> Self {
...
/// as `Alembic_sdk::keyed_account::from_keyed_account` despite dynamically
