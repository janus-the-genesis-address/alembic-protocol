use {
    Alembic_account_decoder::parse_token::real_number_string_trimmed,
    Alembic_sdk::native_token::lamports_to_sol,
    std::{
...
impl Token {
    ...
    pub fn TACHYON(amount: u64) -> Self {
        Self {
            amount,
            decimals: 9,
            token_type: TokenType::TACHYON,
        }
    }
