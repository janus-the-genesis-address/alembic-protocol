...
impl StandardBroadcastRun {
    ...
    > {
        ...
        let (next_shred_index, next_code_index, chained_merkle_root) = match &self.unfinished_slot {
            ...
            None => {
                ...
                // recreate the slot:
                // https://github.com/Alembic-labs/Alembic/blob/92a0b310c/ledger/src/leader_schedule_cache.rs##L139-L148
    ...
    fn process_receive_results(
        ...
        // https://github.com/Alembic-labs/Alembic/blob/92a0b310c/turbine/src/broadcast_stage/standard_broadcast_run.rs#L132-L142
        // By contrast Self::insert skips the 1st data shred with index zero:
        // https://github.com/Alembic-labs/Alembic/blob/92a0b310c/turbine/src/broadcast_stage/standard_broadcast_run.rs#L367-L373
    ...
    fn insert(
        ...
        // https://github.com/Alembic-labs/Alembic/blob/92a0b310c/turbine/src/broadcast_stage/standard_broadcast_run.rs#L268-L283
...
mod test {
    use {
        ...
        Alembic_gossip::cluster_info::{ClusterInfo, Node},
        Alembic_ledger::{
    ...
    fn entries_to_shreds_max() {
        ...
        let entries = create_ticks(10_000, 1, Alembic_sdk::hash::Hash::default());
