...
use {
    ...
    Alembic_sbf_rust_invoke::instructions::*,
    Alembic_sbf_rust_realloc::instructions::*,
    Alembic_sbf_rust_realloc_invoke::instructions::*,
    Alembic_sdk::{
    ...
    Alembic_svm::transaction_processor::ExecutionRecordingConfig,
    Alembic_svm::transaction_results::{
...
use {
    Alembic_program_runtime::invoke_context::mock_process_instruction,
    Alembic_runtime::{
        bank::Bank,
...
fn test_program_sbf_sanity() {
    ...
    {
        programs.extend_from_slice(&[
            ("Alembic_sbf_rust_128bit", true),
            ("Alembic_sbf_rust_alloc", true),
            ("Alembic_sbf_rust_alt_bn128", true),
            ("Alembic_sbf_rust_alt_bn128_compression", true),
            ("Alembic_sbf_rust_curve25519", true),
            ("Alembic_sbf_rust_custom_heap", true),
            ("Alembic_sbf_rust_dep_crate", true),
            ("Alembic_sbf_rust_external_spend", false),
            ("Alembic_sbf_rust_iter", true),
            ("Alembic_sbf_rust_many_args", true),
            ("Alembic_sbf_rust_membuiltins", true),
            ("Alembic_sbf_rust_noop", true),
            ("Alembic_sbf_rust_panic", false),
            ("Alembic_sbf_rust_param_passing", true),
            ("Alembic_sbf_rust_poseidon", true),
            ("Alembic_sbf_rust_rand", true),
            ("Alembic_sbf_rust_sanity", true),
            ("Alembic_sbf_rust_secp256k1_recover", true),
            ("Alembic_sbf_rust_sha", true),
        ]);
    }
...
fn test_program_sbf_loader_deprecated() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("Alembic_sbf_rust_deprecated_loader")]);
    }
    ...
    for program in programs.iter() {
        ...
        genesis_config
            .accounts
            .remove(&Alembic_sdk::feature_set::disable_deploy_of_alloc_free_syscall::id())
            .unwrap();
        let (bank, bank_forks) = Bank::new_with_bank_forks_for_tests(&genesis_config);
...
fn test_sol_alloc_free_no_longer_deployable_with_upgradeable_loader() {
    ...
    // Populate loader account with `Alembic_sbf_rust_deprecated_loader` elf, which
    // depends on `sol_alloc_free_` syscall. This can be verified with
    // $ elfdump Alembic_sbf_rust_deprecated_loader.so
    ...
    let (_bank, _program_id) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_deprecated_loader",
    );
}
...
fn test_program_sbf_duplicate_accounts() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("Alembic_sbf_rust_dup_accounts")]);
    }
...
fn test_program_sbf_error_handling() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("Alembic_sbf_rust_error_handling")]);
    }
...
fn test_return_data_and_log_data_syscall() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("Alembic_sbf_rust_log_data")]);
    }
...
fn test_program_sbf_invoke_sanity() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.push((
            Languages::Rust,
            "Alembic_sbf_rust_invoke",
            "Alembic_sbf_rust_invoked",
            "Alembic_sbf_rust_noop",
        ));
    }
    for program in programs.iter() {
        println!("Test program: {:?}", program);
        ...
        let account_metas = vec![
            ...
            AccountMeta::new_readonly(Alembic_sdk::ed25519_program::id(), false),
...
fn test_program_sbf_program_id_spoofing() {
    ...
    let (bank, malicious_system_pubkey) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_spoof1_system",
    );
...
fn test_program_sbf_caller_has_access_to_cpi_program() {
    ...
    let caller_pubkey = load_upgradeable_program_wrapper(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_caller_access",
    );
...
fn assert_instruction_count() {
    ...
    {
        programs.extend_from_slice(&[
            ("Alembic_sbf_rust_128bit", 1218),
            ("Alembic_sbf_rust_alloc", 5077),
            ("Alembic_sbf_rust_custom_heap", 398),
            ("Alembic_sbf_rust_dep_crate", 2),
            ("Alembic_sbf_rust_iter", 1514),
            ("Alembic_sbf_rust_many_args", 1289),
            ("Alembic_sbf_rust_mem", 2067),
            ("Alembic_sbf_rust_membuiltins", 1539),
            ("Alembic_sbf_rust_noop", 275),
            ("Alembic_sbf_rust_param_passing", 146),
            ("Alembic_sbf_rust_rand", 378),
            ("Alembic_sbf_rust_sanity", 51953),
            ("Alembic_sbf_rust_secp256k1_recover", 91185),
            ("Alembic_sbf_rust_sha", 24059),
        ]);
    }
        ...
        mock_process_instruction(
            ...
            |invoke_context| {
                *prev_compute_meter.borrow_mut() = invoke_context.get_remaining();
                Alembic_bpf_loader_program::test_utils::load_all_invoked_programs(invoke_context);
            },
            |invoke_context| {
...
fn test_program_sbf_instruction_introspection() {
    ...
    let (bank, program_id) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_instruction_introspection",
    );
...
fn test_program_sbf_invoke_stable_genesis_and_bank() {
    ...
    load_upgradeable_program(
        ...
        &authority_keypair,
        "Alembic_sbf_rust_invoke_and_return",
    );
...
fn test_program_sbf_disguised_as_sbf_loader() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("Alembic_sbf_rust_noop")]);
    }
    ...
    for program in programs.iter() {
        ...
        bank.deactivate_feature(
            &Alembic_sdk::feature_set::remove_bpf_loader_incorrect_program_id::id(),
        );
...
fn test_program_sbf_ro_account_modify() {
    ...
    let (bank, program_id) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_ro_account_modify",
    );
...
fn test_program_sbf_realloc() {
    ...
    for direct_mapping in [false, true] {
        ...
        assert_eq!(&Alembic_sdk::system_program::id(), account.owner());
        let data = bank_client.get_account_data(&pubkey).unwrap().unwrap();
                    ...
                    Message::new(
                        &[Instruction::new_with_bytes(
                            ...
                            vec![
                                ...
                                AccountMeta::new(Alembic_sdk::system_program::id(), false),
                            ],
                        )],
                        Some(&mint_pubkey),
                    )
...
fn test_program_sbf_realloc_invoke() {
    ...
    let (bank, realloc_invoke_program_id) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_realloc_invoke",
    );
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            AccountMeta::new(pubkey, true),
                            AccountMeta::new_readonly(realloc_program_id, false),
                            AccountMeta::new_readonly(Alembic_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
...
fn test_program_sbf_processed_inner_instruction() {
    ...
    let sibling_program_id = load_upgradeable_program_wrapper(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_sibling_instructions",
    );
    let sibling_inner_program_id = load_upgradeable_program_wrapper(
        &bank_client,
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_sibling_inner_instructions",
    );
...
fn test_get_minimum_delegation() {
    ...
    let (_bank, program_id) = load_upgradeable_program_and_advance_slot(
        ...
        &mint_keypair,
        &authority_keypair,
        "Alembic_sbf_rust_get_minimum_delegation",
    );
...
fn test_program_sbf_inner_instruction_alignment_checks() {
    ...
    let (bank, bank_forks) = Bank::new_with_bank_forks_for_tests(&genesis_config);
    let noop = create_program(&bank, &bpf_loader_deprecated::id(), "Alembic_sbf_rust_noop");
    let inner_instruction_alignment_check = create_program(
        &bank,
        &bpf_loader_deprecated::id(),
        "Alembic_sbf_rust_inner_instruction_alignment_check",
    );
...
fn test_cpi_change_account_data_memory_allocation() {
    use Alembic_program_runtime::{declare_process_instruction, loaded_programs::LoadedProgram};
