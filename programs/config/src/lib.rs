...
pub use Alembic_sdk::config::program::id;
#[allow(deprecated)]
use Alembic_sdk::stake::config::Config as StakeConfig;
use {
...
// TODO move ConfigState into `Alembic_program` to implement trait locally
#[allow(deprecated)]
