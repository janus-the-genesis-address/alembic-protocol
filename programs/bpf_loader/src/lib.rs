...
macro_rules! create_vm {
    ($vm:ident, $program:expr, $regions:expr, $accounts_metadata:expr, $invoke_context:expr $(,)?) => {
        ...
        let $vm = heap_cost_result.and_then(|_| {
            let mut stack = Alembic_rbpf::aligned_memory::AlignedMemory::<
                { Alembic_rbpf::ebpf::HOST_ALIGN },
            >::zero_filled(stack_size);
            let mut heap = Alembic_rbpf::aligned_memory::AlignedMemory::<
                { Alembic_rbpf::ebpf::HOST_ALIGN },
...
macro_rules! mock_create_vm {
    ($vm:ident, $additional_regions:expr, $accounts_metadata:expr, $invoke_context:expr $(,)?) => {
        ...
        let function_registry = Alembic_rbpf::program::FunctionRegistry::default();
        let executable = Alembic_rbpf::elf::Executable::<InvokeContext>::from_text_bytes(
            &[0x95, 0, 0, 0, 0, 0, 0, 0],
            loader,
            SBPFVersion::V2,
            function_registry,
        ...
        .unwrap();
        executable
            .verify::<Alembic_rbpf::verifier::RequisiteVerifier>()
            .unwrap();
        $crate::create_vm!(
            $vm,
            &executable,
    ...
    match limited_deserialize(instruction_data)? {
        ...
        UpgradeableLoaderInstruction::DeployWithMaxDataLen { max_data_len } => {
            ...
            let signers = [[new_program_id.as_ref(), &[bump_seed]]]
                ...
                .collect::<Result<Vec<Pubkey>, Alembic_sdk::pubkey::PubkeyError>>()?;
...
pub mod test_utils {
    use {
        super::*, Alembic_program_runtime::loaded_programs::DELAY_VISIBILITY_SLOT_OFFSET,
        Alembic_sdk::account::ReadableAccount,
    };
