...
#[allow(deprecated)]
use Alembic_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `Alembic_sdk::stake::config` or `Alembic_program::stake::config` instead"
)]
pub use Alembic_sdk::stake::config::*;
use {
    bincode::deserialize,
    Alembic_config_program::{create_config_account, get_config_data},
    Alembic_sdk::{
