...
#[deprecated(
    since = "1.8.0",
    note = "Please use `Alembic_sdk::stake::program::id` or `Alembic_program::stake::program::id` instead"
)]
pub use Alembic_sdk::stake::program::{check_id, id};
use Alembic_sdk::{
...
pub fn get_minimum_delegation(feature_set: &FeatureSet) -> u64 {
    if feature_set.is_active(&feature_set::stake_raise_minimum_delegation_to_1_sol::id()) {
        ...
        #[allow(deprecated)]
        Alembic_sdk::stake::MINIMUM_STAKE_DELEGATION
    }
}
