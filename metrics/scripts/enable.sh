...
echoAlembic ProtocolMetricsConfig() {
...
Alembic_METRICS_CONFIG=$(echoAlembic ProtocolMetricsConfig)
export Alembic_METRICS_CONFIG
unset -f echoAlembic ProtocolMetricsConfig
