#![cfg(test)]
#[allow(deprecated)]
use Alembic_sdk::sysvar::fees::Fees;
use {
    super::{
    ...
    Alembic_stake_program::stake_state::{self, StakeStateV2},
    Alembic_svm::transaction_results::DurableNonceFee,
    Alembic_vote_program::{
        vote_instruction,
        vote_state::{
...
fn create_genesis_config_no_tx_fee_no_rent(lamports: u64) -> (GenesisConfig, Keypair) {
    ...
    let genesis_config_info = Alembic_runtime::genesis_utils::create_genesis_config(lamports);
    (
...
fn create_genesis_config_no_tx_fee(lamports: u64) -> (GenesisConfig, Keypair) {
    ...
    let (mut genesis_config, mint_keypair) =
        Alembic_sdk::genesis_config::create_genesis_config(lamports);
...
fn test_race_register_tick_freeze() {
    ...
    let p = Alembic_sdk::pubkey::new_rand();
...
fn test_bank_new() {
    let dummy_leader_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_store_account_and_update_capitalization_missing() {
    ...
    let pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_rent_distribution() {
    ...
    let bootstrap_validator_pubkey = Alembic_sdk::pubkey::new_rand();
    ...
    let validator_1_pubkey = Alembic_sdk::pubkey::new_rand();
    ...
    let validator_2_pubkey = Alembic_sdk::pubkey::new_rand();
    ...
    let validator_3_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_rent_exempt_executable_account() {
    ...
    let account_pubkey = Alembic_sdk::pubkey::new_rand();
    let account_balance = 1;
    let mut account = AccountSharedData::new(account_balance, 0, &Alembic_sdk::pubkey::new_rand());
...
fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
    let leader_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_rent_eager_collect_rent_in_partition(should_collect_rent: bool) {
    ...
    for feature_id in FeatureSet::default().inactive {
        if feature_id != Alembic_sdk::feature_set::skip_rent_rewrites::id()
            && (!should_collect_rent
                || feature_id != Alembic_sdk::feature_set::disable_rent_fees_collection::id())
        {
            activate_feature(&mut genesis_config, feature_id);
        }
    }

    let zero_lamport_pubkey = Alembic_sdk::pubkey::new_rand();
    let rent_due_pubkey = Alembic_sdk::pubkey::new_rand();
    let rent_exempt_pubkey = Alembic_sdk::pubkey::new_rand();
    let mut bank = Arc::new(Bank::new_for_tests(&genesis_config));
...
fn do_test_bank_update_rewards_determinism() -> u64 {
    ...
    let vote_id = Alembic_sdk::pubkey::new_rand();
    let mut vote_account =
        vote_state::create_account(&vote_id, &Alembic_sdk::pubkey::new_rand(), 0, 100);
    let stake_id1 = Alembic_sdk::pubkey::new_rand();
    let stake_account1 = crate::stakes::tests::create_stake_account(123, &vote_id, &stake_id1);
    let stake_id2 = Alembic_sdk::pubkey::new_rand();
...
fn test_one_source_two_tx_one_batch() {
    let (genesis_config, mint_keypair) = create_genesis_config_no_tx_fee(sol_to_lamports(1.));
    let key1 = Alembic_sdk::pubkey::new_rand();
    let key2 = Alembic_sdk::pubkey::new_rand();
    let bank = Bank::new_with_bank_forks_for_tests(&genesis_config).0;
    let amount = genesis_config.rent.minimum_balance(0);
    assert_eq!(bank.last_blockhash(), genesis_config.hash());
...
fn test_transfer_to_sysvar() {
    ...
    let normal_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_bank_withdraw() {
    ...
    // Test no account
    let key = Alembic_sdk::pubkey::new_rand();
    assert_eq!(
...
fn test_bank_tx_fee() {
    ...
    let leader = Alembic_sdk::pubkey::new_rand();
    let GenesisConfigInfo {
        mut genesis_config,
        mint_keypair,
        ..
...
fn test_readonly_accounts() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = create_genesis_config_with_leader(500, &Alembic_sdk::pubkey::new_rand(), 0);
    let bank = Bank::new_with_bank_forks_for_tests(&genesis_config).0;

    let vote_pubkey0 = Alembic_sdk::pubkey::new_rand();
    let vote_pubkey1 = Alembic_sdk::pubkey::new_rand();
    let vote_pubkey2 = Alembic_sdk::pubkey::new_rand();
...
fn test_readonly_relaxed_locks() {
    ...
    let key3 = Alembic_sdk::pubkey::new_rand();
...
fn test_bank_hash_internal_state() {
    ...
    let pubkey2 = Alembic_sdk::pubkey::new_rand();
...
fn test_hash_internal_state_order() {
    ...
    assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
    let key0 = Alembic_sdk::pubkey::new_rand();
    let key1 = Alembic_sdk::pubkey::new_rand();
...
fn test_bank_update_sysvar_account() {
    ...
    for pass in 0..5 {
        ...
        let dummy_clock_id = Alembic_sdk::pubkey::new_rand();
...
fn test_bank_vote_accounts() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = create_genesis_config_with_leader(500, &Alembic_sdk::pubkey::new_rand(), 1);
    let bank = Bank::new_with_bank_forks_for_tests(&genesis_config).0;
...
fn test_bank_cloned_stake_delegations() {
    ...
    let (vote_balance, stake_balance) = {
        ...
        let minimum_delegation = Alembic_stake_program::get_minimum_delegation(&bank.feature_set);
        (
...
fn test_is_delta_with_no_committables() {
    ...
    assert_eq!(
        bank.transfer(10_001, &mint_keypair, &Alembic_sdk::pubkey::new_rand()),
        Err(TransactionError::InstructionError(
            0,
            SystemError::ResultWithNegativeLamports.into(),
        ))
...
fn test_bank_get_program_accounts() {
    ...
    assert!(
        genesis_accounts
            .iter()
            .any(|(pubkey, _, _)| Alembic_sdk::sysvar::is_sysvar_id(pubkey)),
        "no sysvars found"
    );

    let bank0 = Arc::new(new_from_parent(parent));
    let pubkey0 = Alembic_sdk::pubkey::new_rand();
    ...
    let pubkey1 = Alembic_sdk::pubkey::new_rand();
...
fn test_add_duplicate_static_program() {
    ...
    bank.add_mockup_builtin(Alembic_vote_program::id(), MockBuiltin::vm);
    let bank = bank_forks
        .write()
        .unwrap()
        .insert(bank)
    ...
    let vote_loader_account = bank.get_account(&Alembic_vote_program::id()).unwrap();
    let new_vote_loader_account = bank.get_account(&Alembic_vote_program::id()).unwrap();
...
fn test_transaction_with_duplicate_accounts_in_instruction() {
    ...
    let from_pubkey = Alembic_sdk::pubkey::new_rand();
    let to_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_account_ids_after_program_ids() {
    ...
    let instruction = Instruction::new_with_bincode(Alembic_vote_program::id(), &10, account_metas);
    let mut tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
    ...
    tx.message.account_keys.push(Alembic_sdk::pubkey::new_rand());
    ...
    let result = bank.process_transaction(&tx);
    assert_eq!(result, Ok(()));
    let account = bank.get_account(&Alembic_vote_program::id()).unwrap();
...
fn test_program_id_as_payer() {
    ...
    tx.message.account_keys.push(Alembic_vote_program::id());
...
fn test_bank_hash_consistency() {
    ...
    activate_feature(
        &mut genesis_config,
        Alembic_sdk::feature_set::set_exempt_rent_epoch_max::id(),
    );
...
fn test_same_program_id_uses_unique_executable_accounts() {
    ...
    let program1_pubkey = Alembic_sdk::pubkey::new_rand();
    let bank =
        Bank::new_with_mockup_builtin_for_tests(&genesis_config, program1_pubkey, MockBuiltin::vm)
            .0;

    // Add a new program owned by the first
    let program2_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_add_builtin_no_overwrite() {
    let slot = 123;
    let program_id = Alembic_sdk::pubkey::new_rand();
...
fn test_add_builtin_loader_no_overwrite() {
    let slot = 123;
    let loader_id = Alembic_sdk::pubkey::new_rand();
...
fn test_reconfigure_token2_native_mint() {
    ...
    let genesis_config =
        create_genesis_config_with_leader(5, &Alembic_sdk::pubkey::new_rand(), 0).genesis_config;
    let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    assert_eq!(
...
fn test_bank_load_program() {
    ...
    let programdata_key = Alembic_sdk::pubkey::new_rand();
...
fn test_bpf_loader_upgradeable_deploy_with_max_len() {
    ...
    mock_process_instruction(
        ...
        Vec::new(),
        Ok(()),
        Alembic_bpf_loader_program::Entrypoint::vm,
        |invoke_context| {
            invoke_context
        ...
        ) + std::marker::Send,
{
    ...
    // Set up initial bank
    let mut genesis_config =
        create_genesis_config_with_leader(10, &Alembic_sdk::pubkey::new_rand(), 374_999_998_287_840)
            .genesis_config;
    ...
    let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(Alembic_sdk::pubkey::new_rand)
        .take(total_pubkeys)
        .collect();
...
fn test_get_inflation_start_slot_devnet_testnet() {
    let GenesisConfigInfo {
        mut genesis_config, ..
    } = create_genesis_config_with_leader(42, &Alembic_sdk::pubkey::new_rand(), 42);
    genesis_config
        .accounts
...
fn test_stake_vote_account_validity() {
    ...
    // https://github.com/Alembic-labs/Alembic/pull/24200#discussion_r849935444
...
fn test_get_largest_accounts() {
    ...
    // Initialize accounts; all have larger TACHYON balances than current Bank built-ins
...
fn test_call_precomiled_program() {
    ...
    let instruction =
        Alembic_sdk::secp256k1_instruction::new_secp256k1_instruction(&secp_privkey, message_arr);
    let tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
    ...
    let message_arr = b"hello";
    let instruction =
        Alembic_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
    let tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
...
fn test_an_empty_instruction_without_program() {
    ...
    let destination = Alembic_sdk::pubkey::new_rand();
...
fn test_invalid_rent_state_changes_fee_payer() {
    ...
    genesis_config.fee_rate_governor = FeeRateGovernor::new(
        Alembic_sdk::fee_calculator::DEFAULT_TARGET_LAMPORTS_PER_SIGNATURE,
        Alembic_sdk::fee_calculator::DEFAULT_TARGET_SIGNATURES_PER_SLOT,
    );
...
fn test_rent_state_incinerator() {
    ...
    for amount in [rent_exempt_minimum - 1, rent_exempt_minimum] {
        bank.transfer(amount, &mint_keypair, &Alembic_sdk::incinerator::id())
            .unwrap();
    }
}
...
fn test_resize_and_rent() {
    ...
    let rent_paying_pubkey = Alembic_sdk::pubkey::new_rand();
...
fn test_accounts_data_size_and_rent_collection(should_collect_rent: bool) {
    ...
    if should_collect_rent {
        genesis_config
            .accounts
            .remove(&Alembic_sdk::feature_set::disable_rent_fees_collection::id());
    }
...
fn test_cap_accounts_data_allocations_per_transaction() {
    ...
    assert_eq!(
        ...
        Err(TransactionError::InstructionError(
            ...
            Alembic_sdk::instruction::InstructionError::MaxAccountsDataAllocationsExceeded,
        )),
    );
}
...
fn test_is_in_slot_hashes_history() {
    use Alembic_sdk::slot_hashes::MAX_ENTRIES;
...
fn test_program_execution_restricted_for_stake_account_in_reward_period() {
    use Alembic_sdk::transaction::TransactionError::ProgramExecutionTemporarilyRestricted;
...
fn test_calc_vote_accounts_to_store_three() {
    ...
    let pubkey = Alembic_sdk::pubkey::new_rand();
    let pubkey2 = Alembic_sdk::pubkey::new_rand();
    let pubkey3 = Alembic_sdk::pubkey::new_rand();
    let mut vote_account = AccountSharedData::default();
    vote_account.set_lamports(u64::MAX);
    vote_account_rewards.insert(
        pubkey,
