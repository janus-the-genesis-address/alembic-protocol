use {
    ...
    Alembic_accounts_db::{accounts_hash::AccountsHash, ancestors::AncestorsForSerialization},
    Alembic_measure::measure::Measure,
    Alembic_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> Alembic_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}
