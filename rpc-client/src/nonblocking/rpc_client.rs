...
#[cfg(feature = "spinner")]
use {crate::spinner, Alembic_sdk::clock::MAX_HASH_AGE_IN_SECONDS, std::cmp::min};
use {
    crate::{
    ...
    Alembic_vote_program::vote_state::MAX_LOCKOUT_HISTORY,
    std::{
        net::SocketAddr,
        str::FromStr,
...
impl RpcClient {
    ...
    ///
    /// ```
    /// # use Alembic_rpc_client::nonblocking::rpc_client::RpcClient;
    ...
    async fn get_node_version(&self) -> Result<semver::Version, RpcError> {
        ...
        if let Some(version) = &*r_node_version {
            ...
            let node_version = semver::Version::parse(&node_version.Alembic_core).map_err(|e| {
    ...
    /// ```
    /// # use Alembic_rpc_client_api::client_error::Error;
    /// # use Alembic_rpc_client::nonblocking::rpc_client::{self, RpcClient};
    /// # use Alembic_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
