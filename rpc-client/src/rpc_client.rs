...
#[allow(deprecated)]
use Alembic_rpc_client_api::deprecated_config::{
...
/// A client of a remote Alembic node.
///
/// `RpcClient` communicates with a Alembic node over [JSON-RPC], with the
/// [Alembic JSON-RPC protocol][jsonprot]. It is the primary Rust interface for
...
/// documentation.
///
/// [`Finalized`]: Alembic_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: Alembic_sdk::commitment_config::CommitmentLevel::Processed
/// [jsonprot]: https://genesisaddress.ai/docs/rpc
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://genesisaddress.ai/docs/terminology#slot
/// [cl]: https://genesisaddress.ai/docs/rpc#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][Alembic_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][Alembic_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][Alembic_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][Alembic_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][Alembic_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use Alembic_sdk::system_transaction;
/// # use Alembic_rpc_client_api::client_error::Error;
/// # use Alembic_rpc_client::rpc_client::RpcClient;
/// # use Alembic_sdk::signature::{Keypair, Signer};
/// # use Alembic_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = Alembic_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
/// [`reqwest::Error`](Alembic_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](Alembic_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: Alembic_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: Alembic_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: Alembic_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: Alembic_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use Alembic_sdk::commitment_config::CommitmentConfig;
    /// # use Alembic_rpc_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    /// behaviors determined by internal Alembic test cases. New users should
    ...
    ///
    /// [`RpcError`]: Alembic_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: Alembic_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: Alembic_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: Alembic_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: Alembic_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://genesisaddress.ai/docs/rpc/http/sendtransaction
    /// [`getLatestBlockhash`]: https://genesisaddress.ai/docs/rpc/http/getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: Alembic_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: Alembic_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`getSignatureStatuses`]: https://genesisaddress.ai/docs/rpc/http/getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`err`]: Alembic_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: Alembic_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://genesisaddress.ai/docs/rpc/http/sendtransaction
    ///
    ...
    /// [`sig_verify`]: Alembic_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://genesisaddress.ai/docs/rpc/http/simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`accounts`]: Alembic_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: Alembic_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://genesisaddress.ai/docs/rpc/http/gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: Alembic_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][Alembic_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    ///
    /// [`getSlot`]: https://genesisaddress.ai/docs/rpc/http/getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://genesisaddress.ai/docs/rpc/http/getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://genesisaddress.ai/docs/rpc/http/getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    /// # use Alembic_rpc_client_api::client_error::Error;
    /// # use Alembic_rpc_client::rpc_client::RpcClient;
    /// # use Alembic_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://genesisaddress.ai/docs/rpc/http/getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://genesisaddress.ai/docs/rpc/http/getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://genesisaddress.ai/docs/rpc/http/getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://genesisaddress.ai/docs/rpc/http/getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://genesisaddress.ai/docs/rpc/http/getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://genesisaddress.ai/docs/rpc/http/getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://genesisaddress.ai/docs/rpc/http/getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # use Alembic_rpc_client_api::client_error::Error;
    /// # use Alembic_rpc_client::rpc_client::RpcClient;
    /// # use Alembic_transaction_status::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    /// # };
    /// # use Alembic_rpc_client::rpc_client::RpcClient;
    /// # use Alembic_transaction_status::{
    /// #     TransactionDetails,
    ...
    ///
    /// [`getBlocks`]: https://genesisaddress.ai/docs/rpc/http/getblocks
    /// [`getConfirmedBlocks`]: https://genesisaddress.ai/docs/rpc/deprecated/getconfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: Alembic_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    ///
    /// [`getBlocksWithLimit`]: https://genesisaddress.ai/docs/rpc/http/getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://genesisaddress.ai/docs/rpc/deprecated/getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getSignaturesForAddress`]: https://genesisaddress.ai/docs/rpc/http/getsignaturesforaddress
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    /// # use Alembic_rpc_client_api::client_error::Error;
    /// # use Alembic_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use Alembic_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`getTransaction`]: https://genesisaddress.ai/docs/rpc/http/gettransaction
    /// [`getConfirmedTransaction`]: https://genesisaddress.ai/docs/rpc/deprecated/getConfirmedTransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://genesisaddress.ai/docs/rpc/http/getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://genesisaddress.ai/docs/rpc/http/getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://genesisaddress.ai/docs/rpc/http/getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://genesisaddress.ai/docs/rpc/http/getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://genesisaddress.ai/docs/rpc/http/getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://genesisaddress.ai/docs/rpc/http/getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://genesisaddress.ai/docs/rpc/http/getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://genesisaddress.ai/docs/rpc/http/getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://genesisaddress.ai/docs/rpc/http/getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://genesisaddress.ai/docs/rpc/http/getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current Alembic version running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://genesisaddress.ai/docs/rpc/http/getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.Alembic_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://genesisaddress.ai/docs/rpc/http/minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError::ForUser`]: Alembic_rpc_client_api::request::RpcError::ForUser
    ...
    ///
    /// [`getAccountInfo`]: https://genesisaddress.ai/docs/rpc/http/getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use Alembic_rpc_client_api::client_error::Error;
    /// # use Alembic_rpc_client::rpc_client::{self, RpcClient};
    /// # use Alembic_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use Alembic_account_decoder::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://genesisaddress.ai/docs/rpc/http/getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://genesisaddress.ai/docs/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://genesisaddress.ai/docs/rpc/http/getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://genesisaddress.ai/docs/rpc/http/getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://genesisaddress.ai/docs/rpc/http/getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://genesisaddress.ai/docs/rpc/http/getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://genesisaddress.ai/docs/rpc/http/getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use Alembic_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://genesisaddress.ai/docs/rpc/http/getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
...
mod tests {
    use {
        ...
        Alembic_rpc_client_api::client_error::ErrorKind,
        Alembic_sdk::{
