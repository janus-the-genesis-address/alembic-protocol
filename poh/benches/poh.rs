// This bench attempts to justify the value of `Alembic_core::poh_service::NUM_HASHES_PER_BATCH`

#![feature(test)]
extern crate test;

use {
    Alembic_entry::poh::Poh,
    Alembic_poh::poh_service::DEFAULT_HASHES_PER_BATCH,
