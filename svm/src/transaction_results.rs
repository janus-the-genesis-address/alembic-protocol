// Re-exported since these have moved to `Alembic_sdk`.
#[deprecated(
    since = "1.18.0",
    note = "Please use `Alembic_sdk::inner_instruction` types instead"
)]
pub use Alembic_sdk::inner_instruction::{InnerInstruction, InnerInstructionsList};
use {
    Alembic_program_runtime::loaded_programs::LoadedProgramsForTxBatch,
    Alembic_sdk::{
