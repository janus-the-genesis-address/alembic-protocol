...
//!
//! The [`PubsubClient`] implements [Alembic WebSocket event
//! subscriptions][spec].
//!
//! [spec]: https://genesisaddress.ai/docs/rpc/websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `Alembic-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/Alembic-rpc/latest/Alembic_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/Alembic-rpc/latest/Alembic_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use Alembic_pubsub_client::pubsub_client::PubsubClient;
//! use Alembic_rpc_client_api::config::RpcAccountInfoConfig;
//! use Alembic_sdk::pubkey::Pubkey;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.genesisaddress.ai/";
//!
...
//! }
//! #
//! # get_account_updates(Alembic_sdk::pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
...
use {
    ...
    Alembic_account_decoder::UiAccount,
    ...
    Alembic_sdk::{clock::Slot, pubkey::Pubkey, signature::Signature},
    std::{
        marker::PhantomData,
        net::TcpStream,
        sync::{
    ...
    fn get_version(
        ...
        if let Ok(json_msg) = serde_json::from_str::<Map<String, Value>>(message_text) {
            if let Some(Object(version_map)) = json_msg.get("result") {
                if let Some(node_version) = version_map.get("Alembic-core") {
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `Alembic-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/blocksubscribe
    ...
    ///
    /// [`logsSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `Alembic-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/votesubscribe
    ...
    /// validator.
    ///
    /// [root]: https://genesisaddress.ai/docs/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://genesisaddress.ai/docs/rpc/websocket/slotsupdatessubscribe
